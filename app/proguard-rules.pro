...
#
## Glide's PreferencesLocation
#-keep public class com.bumptech.glide.load.engine.prefill.PreFillTypeAdapterFactory$GeneratedTypeAdapter
#-keep public class com.bumptech.glide.load.engine.prefill.PreFillTypeAdapterFactory$Item
