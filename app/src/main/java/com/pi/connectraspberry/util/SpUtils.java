...
public class SpUtils {
    ...
    public static void putConfig(String key, float value) {
        MyApplication.getInstance().getSharedPreferences("config", Context.MODE_PRIVATE).edit().putFloat(key, value).apply();
    }
    ...
    public static float getConfig(String key, float defaultValue) {
        return MyApplication.getInstance().getSharedPreferences("config", Context.MODE_PRIVATE).getFloat(key, defaultValue);
    }
